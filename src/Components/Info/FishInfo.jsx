...
const sections = [
    ...
    },
    {
        ...
        content:
            "Ձկներին պետք է տալ այնպիսի կեր, որը համապատասխանում է նրանց տեսակին՝ բուսակեր, մսակեր կամ խառը սնունդ պահանջող։ Ավելի լավ է կերակրել օրական 1–2 անգամ՝ այնքան, որքան կուտեն 1–2 րոպեում, որպեսզի ջուրը չկեղտոտվի։ Չափից շատ կերը փչացնում է ջրի որակը և դառնում հիվանդությունների պատճառ, իսկ բազմազան սնունդը օգնում է գույնին, աճին և իմունիտետին։",
    },
    {
        title: "Ակվարիումի մաքրություն և ջրի որակ 🧪💦",
        image: img("Ակվարիումի մաքրություն և ջրի որակ.png"),
        content:
            "Ձկների առողջության ամենակարևոր գործոնը ջրի որակն է։ Ֆիլտրը պետք է աշխատի մշտապես, իսկ ջրի մասային փոխարինումը (օրինակ՝ շաբաթական) պահում է միջավայրը կայուն։ Չի կարելի միանգամից ամբողջ ջուրը փոխել՝ դա սթրես է տալիս ձկներին։ Քլորը, ջրի կտրուկ ջերմաստիճանային փոփոխությունը և կեղտը արագ բերում են խնդիրների, դրա համար կայունությունն առաջնային է։",
    },
    {
        title: "Ձկների հիվանդությունների վաղ նշանները և կանխարգելում ⚠️🐟",
