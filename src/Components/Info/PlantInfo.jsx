...
export default function PlantInfo() {
    ...
    return (
        <div className="bg-[#E6F5E6] text-gray-800">
            <header className="bg-[#A8D5A2] text-white py-8 text-center">
                <h1 className="text-4xl font-bold">🌿 Բնության անկյուն — Բույսերի մասին</h1>
                <p className="mt-2 text-lg">Ուսուցողական էջ՝ բույսերի կարևոր տեղեկություններով</p>
            </header>
            <button
                onClick={() => navigate(-1)}
                ...
                {sections.map((section, index) => (
                    ...
                    >
                        ...
                        <div className="md:w-1/2 p-8 md:p-12">
                            <h2 className="text-3xl font-bold text-[#A8D5A2] mb-4">{section.title}</h2>
