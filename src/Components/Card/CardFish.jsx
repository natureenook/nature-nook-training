...
const CardFish = () => {
    const cards = [
        {
            img: `${import.meta.env.BASE_URL}quizz_fishes.png`,
            title: "Հարցեր Quiz",
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 py-10 bg-gradient-to-br from-sky-50 via-blue-50 to-cyan-100">
