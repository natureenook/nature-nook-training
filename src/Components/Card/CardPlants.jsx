...
const CardPlants = () => {
    const cards = [
        {
            img: `${import.meta.env.BASE_URL}quizz_plants.png`,
            title: "Հարցեր Quiz",
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 py-10 bg-gradient-to-br from-green-50 via-emerald-50 to-lime-100">
