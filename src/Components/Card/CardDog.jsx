...
const CanvasCard = ({ img, title, details, reverse, link }) => {
    return (
        ...
        >
            <div className={`absolute top-10 w-full h-full z-0 transform -rotate-[10deg] -skew-[10deg] group-hover:-rotate-[14deg] group-hover:-skew-[14deg] group-hover:scale-[0.96] transition-all duration-300`}>
            ...
            <div className={`absolute inset-0 flex flex-col justify-center items-center text-center z-20 text-yellow-400`}>
