...
//     const [start, setStart] = useState(false); // Քանի որ սեղմել են «Սկսել սովորել» և լցվել է loading
...
//                 percent += 2; // Loading արագություն
//                 setProgress(percent);
//                 if (percent >= 100) {
//                     clearInterval(interval);
//                     setTimeout(() => setStart(true), 500); // փոքր դելեյ՝ հետո բացի Main content
//                 }
//             }, 60);
...
//     // Եթե loading ավարտված է -> ցույց տալ Main
...
//                     Մենք այս Training-ի ընթացքում կսովորենք կենդանիների, շների, թռչունների, բույսերի
//                     և ձկների մասին ամենակարևոր նրբությունները։ Կսովորենք՝ ինչպես ճիշտ խնամել նրանց,
//                     հասկանալ բնության լեզուն և լինել նրա մաս։
//                     <br />
...
//                 {/* Սկսել սովորել կոճակը / progress bar */}
//                 {!loading ? (
//                     <button
