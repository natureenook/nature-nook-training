...
export default function PlantQuiz() {
    ...
    const questions = useMemo(
        () => [
  {
    question: "Ինչո՞ւ էր բույսերի «ցամաք բարձրանալը» կարևոր Երկրի պատմության մեջ 🌍🌱",
    options: [
    ...
    correct: 1,
    explanation: "Բույսերի զարգացումը ցամաքում նպաստեց թթվածնի ավելացմանն ու կենդանական կյանքի զարգացմանը։",
  },
  {
    question: "Ինչո՞ւ է ֆոտոսինթեզը կարևոր ոչ միայն բույսերի, այլ նաև մարդկանց համար ☀️",
    options: [
    ...
    correct: 0,
    explanation: "Ֆոտոսինթեզի արդյունքում բույսերը արտադրում են թթվածին, որն անհրաժեշտ է կենդանի օրգանիզմներին։",
  },
  {
    ...
    correct: 0,
    explanation: "Տերևների դեղնելը հաճախ կապված է ջրման կամ լուսավորության սխալ ռեժիմի հետ։",
  },
  {
    question: "Ինչո՞ւ չի կարելի բույսը հաճախ տեղափոխել տարբեր միջավայրեր 🚫",
    options: [
    ...
    correct: 1,
    explanation: "Բույսերը զգայուն են միջավայրի փոփոխությունների նկատմամբ և կարող են սթրես ապրել։",
  },
  {
    ...
    correct: 1,
    explanation: "Շատ բույսեր գիշերը նվազեցնում են ջրի կորուստը՝ փակելով տերևները։",
  },
  {
    ...
    correct: 1,
    explanation: "Փշերը օգնում են նվազեցնել գոլորշիացումը և պաշտպանում են բույսը։",
  },
  {
    ...
    correct: 1,
    explanation: "Ծովային ջրիմուռները արտադրում են մոլորակի թթվածնի մեծ մասը։",
  },
  {
    ...
    correct: 0,
    explanation: "Առողջ բույսն ունի մաքուր, կանաչ և փայլուն տերևներ ու կայուն աճ։",
  },
  {
    ...
    correct: 0,
    explanation: "Գերաջրումը կարող է առաջացնել արմատների փտում և թթվածնի պակաս։",
  },
  {
    question: "Ինչո՞ւ են հսկա ծառերը համարվում «ժամանակի կենդանի վկաներ» ⏳🌳",
    options: [
    ...
    correct: 1,
    explanation: "Որոշ ծառեր ապրում են հարյուրավոր և նույնիսկ հազարավոր տարիներ։",
  },
],
        []
    );
