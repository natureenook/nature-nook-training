    ...
    const questions = useMemo(
        () => [
            ...
            },
            {
                ...
                correct: 3,
                explanation:
                    "Շաքարավազը և մեծ քանակությամբ շաքարը անպետք են ձկների համար ու կարող են վնասել առողջությանը։",
            },
            {
            ...
            },
            {
                ...
                correct: 0,
                explanation:
                    "Շատ ձկներ ունեն զարգացած տեսողություն՝ հատկապես գույների և շարժումների ընկալման մեջ։",
            },
        ],
        []
    );
