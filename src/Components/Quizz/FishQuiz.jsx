...
const REDIRECT_TO = "/FishInfo"; // փոխիր՝ օրինակ "/" կամ "/FishInfo"
...
export default function FishQuiz() {
    ...
    const questions = useMemo(
        () => [
  {
    question: "Եթե ձկները առաջացել են ավելի քան 500 միլիոն տարի առաջ, ի՞նչ է դա ցույց տալիս նրանց մասին 🐟",
    options: [
    ...
    correct: 1,
    explanation: "Ձկները Երկրի ամենահին ողնաշարավոր խմբերից են և երկար ժամանակ հաջողությամբ հարմարվել են միջավայրին։",
  },
  {
    ...
    correct: 0,
    explanation: "Խռիկները թույլ են տալիս ձկներին վերցնել ջրում լուծված թթվածինը։",
  },
  {
    question: "Եթե ակվարիումի ջուրը աղտոտ է կամ հազվադեպ է փոխվում, ի՞նչ կարող է պատահել ձկներին 🚫",
    options: [
  ...
  },
  {
    ...
    correct: 1,
    explanation: "Մարդու սնունդը հաճախ պարունակում է աղ, ճարպ կամ հավելումներ, որոնք վնասակար են ձկների համար։",
  },
  {
    ...
    correct: 0,
    explanation: "Ձկները կարևոր դեր ունեն սննդի շղթայում և միջավայրի հավասարակշռության մեջ։",
  },
  {
    question: "Եթե ձուկը անընդհատ լողում է անկանոն կամ սահում է պատերին, ի՞նչ կարող է դա նշանակել 🐠",
    options: [
    ...
    correct: 1,
    explanation: "Վարքի կտրուկ փոփոխությունները հաճախ առողջական խնդիրների նշան են։",
  },
  {
    ...
    correct: 0,
    explanation: "Ձկները սառնարյուն են, և ջերմաստիճանը անմիջապես ազդում է նրանց օրգանիզմի աշխատանքի վրա։",
  },
  {
    ...
    correct: 1,
    explanation: "Ակտիվությունը և պայծառ գունավորումը առողջության լավ նշաններ են։",
  },
  {
    ...
    correct: 1,
    explanation: "Չուտված սնունդը փչացնում է ջրի որակը և կարող է առաջացնել հիվանդություններ։",
  },
  {
    ...
    correct: 1,
    explanation: "Խնամքը, ջրի որակը և սնուցումը մեծ ազդեցություն ունեն ձկների կյանքի տևողության վրա։",
  },
],
        []
    );
